...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "jtest-navi-ja" },
      { name: "description", content: "日本へ留学する人とTHPT外国語免除する人向けの逆算診断ツールです。" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "jtest-navi-ja" },
      { property: "og:description", content: "日本へ留学する人とTHPT外国語免除する人向けの逆算診断ツールです。" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "jtest-navi-ja" },
      { name: "twitter:description", content: "日本へ留学する人とTHPT外国語免除する人向けの逆算診断ツールです。" },
